 ...
 */
public class EditTextListViewAdapter extends ArrayAdapter<String> {
    ...
    public EditTextListViewAdapter(Context context, int resource, ArrayList<String> arrayNames){
